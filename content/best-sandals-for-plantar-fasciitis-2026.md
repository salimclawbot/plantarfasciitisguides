---
title: "Best Sandals for Plantar Fasciitis (2026)"
description: "These top-rated sandals for plantar fasciitis provide arch support, heel cushioning, and pain relief so you can walk comfortably all day. Read our 2026 guide."
slug: best-sandals-for-plantar-fasciitis-2026
...
The right sandal interrupts this cycle. It does three things: it supports the arch so the fascia does not overstretch, it cushions the heel to absorb impact, and it stabilises the rearfoot so your gait stays neutral. Clinical guidelines from the [American College of Foot and Ankle Surgeons](https://www.acfas.org/) identify prescriptive footwear as a first-line, non-invasive treatment for plantar fasciitis. The sandals in this guide were selected specifically because they meet the biomechanical criteria that allow the fascia to rest and heal.
...
We cross-referenced recommendations from the [American Podiatric Medical Association (APMA)](https://www.apma.org/) Seal of Approval program, peer-reviewed footwear biomechanics research, and verified user reviews from people managing chronic heel pain. No brand paid for placement on this list.
...
Supportive footwear and stretching work synergistically. The sandals reduce ongoing strain; the stretches reduce fascial tightness. The [Physiopedia guide on plantar fasciitis](https://www.physio-pedia.com/Plantar_Fasciitis) recommends a combination of plantar fascia-specific stretches, calf stretches, and intrinsic foot strengthening alongside footwear modifications for optimal outcomes.
...
1. **American College of Foot and Ankle Surgeons (ACFAS).** "Plantar Fasciitis: Diagnosis and Treatment." Clinical Practice Guidelines. [acfas.org](https://www.acfas.org/).

2. **American Podiatric Medical Association (APMA).** "Plantar Fasciitis." Patient Education Resource. [apma.org](https://www.apma.org/).

3. **Riddle, D. L., & Schappert, S. M.** (2004). "Volume of Ambulatory Care Visits and Patterns of Care for Patients Diagnosed with Plantar Fasciitis." *Foot & Ankle International*, 25(5), 303–310. [PubMed: PMC3687890](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3687890/).
...
6. **Salter, N., et al.** (2014). "OOFAS: A Novel Impact-Absorbing Footwear Technology — Biomechanical Evaluation." *Journal of Foot and Ankle Research*, 7(Suppl 1), A38. [DOI: 10.1186/1757-1146-7-S1-A38](https://jfootankleres.biomedcentral.com/articles/10.1186/1757-1146-7-S1-A38).

7. **Physiopedia.** "Plantar Fasciitis." Clinical Resource. [physio-pedia.com](https://www.physio-pedia.com/Plantar_Fasciitis).
