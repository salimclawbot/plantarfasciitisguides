...
export default function EditorialGuidelinesPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-6">
      ...
      <p className="text-lg text-gray-600">How we research, write, and review content at Plantar Fasciitis Guides.</p>
      ...
      <p><a href="/" className="text-blue-600 hover:underline">← Back to Plantar Fasciitis Guides</a></p>
    </div>
  );
}
