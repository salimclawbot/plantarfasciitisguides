  ...
  return (
    <footer className="mt-16 border-t border-cyan-100 bg-cyan-50/40">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 text-sm text-slate-700 sm:px-6 md:grid-cols-3">
        <div>
          <h3 className="font-semibold text-slate-900">Air Fryer Oven Guide</h3>
          <p className="mt-2">Expert air fryer toaster oven reviews, comparisons, and buying guides for cleaner indoor air.</p>
        </div>
        <div>
      ...
      <div className="border-t border-cyan-100 py-4 text-center text-xs text-slate-500">© {new Date().getFullYear()} Air Fryer Oven Guide</div>
    </footer>
  );
}
